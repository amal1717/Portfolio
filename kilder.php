                       ...
                       <section id="oversigtoversiden">
                            <nav>
                                <ul>
                                    ...
                                    <li><a class="list-item" href="#pdf">PDF-filer</a></li>
                                    <li><a class="list-item" href="#internet">Internetkilder</a></li>
                                    <li><a class="list-item" href="#boeger">Bøger</a></li>
                                </ul>
                            </nav>
                        </section>
                    ...
                    <section>
                        ...
                        <p>
                            ...
                            Bogner, C. (21. oktober 2020). Quick'n Dirty Video. Hentet fra Grundlæggende faglighed: <a href="pdf_filer/quick'n_dirty.pdf" target="_blank">Quick'n Dirty.pdf</a>
                                <br><br>
                            Bro kommunikation. (16. december 2020). 21 sproglige dødssynder. Hentet fra Grundlæggende faglighed: <a href="pdf_filer/21_sproglige_dodssynder.pdf" target="_blank">21 sproglige dødssynder.pdf</a>
                                <br><br>
                            Friis, N. (2015). Kapitel 5. I H.-C. Christiansen, & G. B. Rose, Sprog og formidling (s. 186-222). Hans Reitzels Forlag. Hentet fra Grundlæggende faglighed: <a href="pdf_filer/Online_kommunikation_kap_5.pdf" target="_blank">Online kommunikation - Sprog og formidling.pdf</a>
                                <br><br>
                            Hald, M. (2008). Kapitel 4 - Kropssprog - Nonverbal kommunikation. I Præsentation og formidling (s. 45-52). København: Hans Reitzels Forlag. Hentet fra Grundlæggende faglighed: <a href="pdf_filer/praesentation_og_formidling.pdf" target="_blank">Præsentation og formidling.pdf</a>
                                <br><br>
                            Schmith, M. (4. november 2020). Business Model Canvas. Hentet fra Grundlæggende faglighed: <a href="pdf_filer/BMC.pdf" target="_blank">Business Model Canvas.pdf</a>
                                <br><br>
                            Schmith, M. (16. september 2020). Grundlæggende kommunikation. Hentet fra Grundlæggende faglighed: <a href="pdf_filer/kommunikation.pdf" target="_blank">Kommunnikation.pdf</a>
                                <br><br>
                            ...
                            Schmith, M. (30. oktober 2020). Tekstproduktion. Hentet fra Grundlæggende faglighed: <a href="pdf_filer/tekstproduktion.pdf" target="_blank">Tekstproduktion.pdf</a>
                                <br><br>
                            Østergaard, N. (2. november 2020). Informationsarkitektur. Hentet fra Grundlæggende faglighed: <a href="pdf_filer/informationsarkitektur.pdf" target="_blank">Informationsarkitektur.pdf</a>
                                <br><br>
                            Østergaard, N. (11. september 2020). Internettets historie og serverbegrebet. Hentet fra Grundlæggende faglighed: <a href="pdf_filer/Serverbegrebet.pdf" target="_blank">Serverbegrebet.pdf</a>
                                <br><br>
                            Østergaard, N. (14. september 2020). Intro til CSS. Hentet fra Grundlæggende faglighed: <a href="pdf_filer/Intro_til_CSS.pdf" target="_blank">Intro til CSS.pdf</a>
                                <br><br>
                            Østergaard, N. (10. september 2020). Introduktion til HTML. Hentet fra Grundlæggende faglighed: <a href="pdf_filer/Intro_til_HTML.pdf" target="_blank">Intro til HTML.pdf</a>
                                <br><br>
                            Østergaard, N. (23. oktober 2020). Kamerateknik. Hentet fra Grundlæggende faglighed: <a href="pdf_filer/introduktion_til_fotografering.pdf" target="_blank">Introduktion til fotografering.pdf</a>
                                <br><br>
                            Østergaard, N. (15. september 2020). Responsive design + CSS Grid. Hentet fra Grundlæggende faglighed: <a href="pdf_filer/CSS_grid.pdf" target="_blank">CSS grid.pdf</a>
                                <br><br>
                        ...
                        <p>
                            ...
                            Design Thinking projekt - Fase 1 . (5. oktober 2020). Hentet fra MMD 2020-2021 Design Thinking projek: <a href="https://eadania.mrooms.net/course/view.php?id=2759#section-6" target="_blank">https://eadania.mrooms.net/course/view.php?id=2759#section-6</a>
                                <br><br>
                            Design Thinking projekt - fase 3. (7. oktober 2020). Hentet fra MMD 2020-2021 Design Thinking projekt: <a href="https://eadania.mrooms.net/course/view.php?id=2759#section-8" target="_blank">https://eadania.mrooms.net/course/view.php?id=2759#section-8</a>
                                <br><br>
                            ...
                            Pexels. (28. oktober 2020). Hentet fra pexels.com: <a href="https://www.pexels.com/da-dk/" target="_blank">https://www.pexels.com/da-dk/</a>
                                <br><br>
                            Phillips, D. J. (14. april 2014). How to aviod death by PowerPoint . Hentet fra Youtube.com: <a href="https://www.youtube.com/watch?v=Iwpi1Lm6dFo" target="_blank">https://www.youtube.com/watch?v=Iwpi1Lm6dFo</a>
                                <br><br>
                            ...
                            Tool galleries. (15. november 2017). Hentet fra helpx.adobe.com: <a href="https://helpx.adobe.com/illustrator/using/tool-galleries.html" target="_blank">https://helpx.adobe.com/illustrator/using/tool-galleries.html</a>
                                <br><br>
                            Understanding Color. (27. februar 2014). Hentet fra youtube.com: <a href="https://www.youtube.com/watch?v=Qj1FK8n7WgY&feature=youtu.be" target="_blank">https://www.youtube.com/watch?v=Qj1FK8n7WgY&feature=youtu.be</a>
                                <br><br>
                            Unsplash. (28. oktober 2020). Hentet fra unsplash.com: <a href="https://unsplash.com" target="_blank">https://unsplash.com</a>

                        </p>
                        
                        <h3 id="boeger">Bøger:</h3>
                        <h4>International markedsføring</h4>
                        <p>
                        ...
                        <h4>Kommunikation i multimediedesign</h4>
                        <p>
                            Busch, A. (2015). Kapitel 11 - Informationsarkitektur. I Kommunikation i multimediedesign (s. 165-182). Hans Reitzels Forlag.
                                <br><br>
                            Busch, A. (2015). Kapitel 22 - Præsentation. I Kommunikation i multimediedesign (s. 315-330). Hans Reitzels Forlag.
                                <br><br>
                            Busch, A. (2015). Kapitel 5 - Grundlæggende kommunikationsteori. I Kommunikation i multimediedesign (s. 67-82). Hans Reitzels Forlag.
                                <br><br>
                            Busch, A. (2015). Kapitel 6 - Kvantitativ og kvalitativ empiri. I Kommunikation i multimediedesign (s. 83-102). Hans Reitzels Forlag.
                                <br><br>
