                            ...
                            <div style="overflow-x:auto;">
                               <table id="tabel">
                                  ...
                                  <tr>
                                    ...
                                    <td><a href="http://10763.apache.eadania.dk/video" target="_blank">Hjemmeside</a></td>
                                  </tr>
                                    <tr>
                                    <td>Baggrunde - Billeder og gradients</td>
                                    <td>Drescher og Nicolaj</td>
                                    <td><a href="http://10850.apache.eadania.dk/workshop/Index.html" target="_blank">Hjemmeside</a></td>
                                  </tr>
                                    <tr>
                                    <td>Tabeller - HTML og CSS</td>
                                    <td>Lissi og Veli</td>
                                    <td><a href="http://10745.apache.eadania.dk/tables" target="_blank">Hjemmeside</a></td>
                                  </tr>
                                    <tr>
                                    <td>Formularer, felttyper og formatering</td>
                                    <td>Amalie og Andreas</td>
                                    <td><a href="http://10743.apache.eadania.dk/HTML Forms/Index.html" target="_blank">Hjemmeside</a></td>
                                  </tr>
                                    <tr>
                                    <td>Karaktersæt, emojis, symboler og entities</td>
                                    <td>Hanne og Terkel</td>
                                    <td><a href="http://10737.apache.eadania.dk/workshop/" target="_blank">Hjemmeside</a></td>
                                  </tr>
                                    <tr>
                                    <td>Animationer og transitions</td>
                                    <td>Jonas og Maja</td>
                                    <td><a href="http://10741.apache.eadania.dk/Animation/" target="_blank">Hjemmeside</a></td>
                                  </tr>
                                    <tr>
                                    <td>CSS selectors</td>
                                    <td>Alberte og Naib</td>
                                    <td><a href="http://albe0507.apache.eadania.dk/CSSselectors/" target="_blank">Hjemmeside</a></td>
                                  </tr>
                                    <tr>
                                    <td>SVG</td>
                                    <td>Sebastian og Nicklas</td>
                                    <td><a href="http://10822.apache.eadania.dk/index.html?fbclid=IwAR2BRTjaVrqqpTgPRj9eL-I7xzOJsTK514zZ1PmaVnD30BL3OMqNBMJhdpE" target="_blank">Hjemmeside</a></td>
                                  </tr>
                                    <tr>
                                    <td>Rammer og skygger</td>
                                    <td>Bjarne og Christine</td>
                                    <td><a href="http://10747.apache.eadania.dk/skygger-og-rammer/index.html" target="_blank">Hjemmeside</a></td>
                                  </tr>
                                    <tr>
                                    <td>Semantiske tags og head</td>
                                    <td>Nuunu og Sine</td>
                                    <td><a href="http://10854.apache.eadania.dk/semantisk/?fbclid=IwAR29j6hUMGbjaYR4mqHcNC-MS9G0StqHn0EOaALlvMmT_oUTTZORa1hIia4" target="_blank">Hjemmeside</a></td>
                                  </tr>
                            </table>
                        </div>
                    </section>
