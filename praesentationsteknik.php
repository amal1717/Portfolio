                        ...
                        <section id="oversigtoversiden">
                            <nav>
                                <ul>
                                    ...
                                    <li><a class="list-item" href="#praesentationsteknik">Præsentationsteknik</a></li>
                                    <li><a class="list-item" href="#mundtlig">Mundtlig præsentation</a></li>
                                    <li><a class="list-item" href="#tips1">Tips og tricks til præsentationsteknik</a></li>
                                     <li><a class="list-item" href="#tips2">Tips og tricks til PowerPoints</a></li>
