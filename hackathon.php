                ...
                <section id="mitgrid">
                    ...
                    <section id="">
                        ...
                        <img src="Billeder/Hackathon/Design-Thinking-Model.png" alt="Design thinking model">
                             <br><br>
                        <img class="billeder" src="Billeder/Hackathon/hackathon1.png" alt="">
                            <br><br>
                        <img class="billeder" src="Billeder/Hackathon/hackathon2.png" alt="">
                            <br><br>
                        <img class="billeder" src="Billeder/Hackathon/hackathon3.png" alt="">
                            <br><br>
                        <img class="billeder" src="Billeder/Hackathon/hackathon4.png" alt="">
